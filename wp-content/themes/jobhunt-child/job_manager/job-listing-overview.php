...
$job_overview_details = apply_filters( 'jobhunt_single_job_overview_details', array(
  'categorie' => array(
      'icon'          => 'la la-list-ul',
      'label'         => esc_html__( 'Catégorie', 'jobhunt' ),
      'taxonomy'      => 'job_listing_category',
  ), /**** Ajout ****/
  'a_distance' => array(
      'icon'          => 'la la-home',
      'label'         => esc_html__( 'Réalisable à distance', 'jobhunt' ),
      'taxonomy'      => 'a_distance',
  ), /**** Ajout ****/
  'frequence' => array(
      'icon'          => 'la la-clock-o',
      'label'         => esc_html__( 'Fréquence souhaitée', 'jobhunt' ),
      'taxonomy'      => 'job_listing_type',
  ),
    'gender' => array(
        'icon'          => 'la la-home',
        'label'         => esc_html__( 'Genre', 'jobhunt' ),
