...
/**
 * Plugin Name: Agiraa
 * Description: Plugin permettant de réaliser les actions impossible à réaliser dans le thème
 * Ce plugin surcharge entre autre la function wp_new_user_notification. 
 * Version: 1.0
 * Author: BNORMAND
 * Date : 10/09/2020
 */
 ...
 /**
 * Override new user notification from bnwp ! 
 *
	...
	function wp_new_user_notification( $user_id, $deprecated = null, $notify = '' ) {
		...
		if ( version_compare( $wp_version, '4.3', '>=' ) ) {
			...
			if ( $bnfw->notifier->notification_exists( 'new-user', false ) ) {
				...
				$password_url  = network_site_url("/mon-compte/mdp-perdu/?action=rp&key=$key&login=" . rawurlencode($user->user_login), 'login');
